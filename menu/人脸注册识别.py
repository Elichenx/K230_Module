...
class FaceRecognition:
    ...
    # 绘制识别结果
    def draw_result(self,pl,rgb565_img,dets,recg_results):
        ...
        if dets:
            for i,det in enumerate(dets):
                ...
                rgb565_img.draw_rectangle(x1,y1, w, h, color=(255,0, 0, 255), thickness = 2)
                # （2）写人脸识别结果
                recg_text = recg_results[i]
                rgb565_img.draw_string_advanced(x1,y1,16,recg_text,color=(255, 255, 0, 0))
...
#        with ScopedTiming("total", 1):
        ...
        # 在 RGB565 图像上绘制检测框
        fr.draw_result(pl,rgb565_img,det_boxes,recg_res)   # 绘制推理结果
